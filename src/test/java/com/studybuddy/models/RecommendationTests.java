...
public class RecommendationTests {
    ...
    public void recommendFreeTimesFromMorningToNight() {
        List<TimeChunk> recs = RecommendationAlgorithm.makeBetterRecommendation(jan_1_2019_8_00_AM, jan_2_2019_12_00_AM, new ArrayList<>(), 1, 16);
        assertEquals(16,recs.size());
    }

    @Test
    public void recommendFreeTimesFromForEntireFreeDay() { // Must account for sleep time
        List<TimeChunk> recs = RecommendationAlgorithm.makeBetterRecommendation(jan_1_2019_12_00_AM, jan_2_2019_12_00_AM, new ArrayList<>(), 1, 16);
        assertEquals(16,recs.size());
    }

    @Test
    public void recommendOnlyTimesWithPositiveValues() { // Don't recommned times when people are mostly asleep
        List<TimeChunk> recs = RecommendationAlgorithm.makeBetterRecommendation(jan_1_2019_12_00_AM, jan_2_2019_12_00_AM, new ArrayList<>(), 1, 24);
        assertEquals(16,recs.size());
    }

    @Test
    public void studyTimesAreCorrectLength() {
        List<TimeChunk> recs = RecommendationAlgorithm.makeBetterRecommendation(jan_1_2019_12_00_AM, jan_2_2019_12_00_AM, new ArrayList<>(), 1, 1);
        ...
        recs = RecommendationAlgorithm.makeBetterRecommendation(jan_1_2019_12_00_AM, jan_2_2019_12_00_AM, new ArrayList<>(), 4, 1);
    ...
    public void recommendationCompressesTimeIntoStartEndInterval() { // Don't worry about event times that are outside specified interval
        ...
        List<TimeChunk> recs = RecommendationAlgorithm.makeBetterRecommendation(jan_1_2019_10_00_AM, jan_1_2019_2_00_PM, list, 1, 4);
    ...
    public void recommendationsDoNotRecommendFilledTime() {
        ...
        List<TimeChunk> recs = RecommendationAlgorithm.makeBetterRecommendation(jan_1_2019_12_00_AM, jan_2_2019_12_00_AM, list, 2, 5);
    ...
    public void recommendationsDontScheduleDuringOverSchedule() {
        ...
        list.add(new TimeChunk(jan_1_2019_10_00_AM, jan_1_2019_12_00_PM));
        list.add(new TimeChunk(jan_1_2019_2_00_PM, jan_1_2019_6_00_PM));
        List<TimeChunk> recs = RecommendationAlgorithm.makeBetterRecommendation(jan_1_2019_12_00_AM, jan_2_2019_12_00_AM, list, list, 2, 20);
        assertEquals(5,recs.size());
        assertEquals(recs.get(1).getStartTime().toEpochSecond(ZoneOffset.UTC), jan_1_2019_12_00_PM.toEpochSecond(ZoneOffset.UTC));
        assertEquals(recs.get(3).getStartTime().toEpochSecond(ZoneOffset.UTC), jan_1_2019_8_00_PM.toEpochSecond(ZoneOffset.UTC));
    }
