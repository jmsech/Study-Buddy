...
public class InitializationRepository {
    ...
    public static void initializeTables(Connection connection) throws SQLException {
        ...
        statement.execute("CREATE TABLE IF NOT EXISTS courses (courseId TEXT, courseNum TEXT, courseDescription TEXT, courseSectionNum TEXT, courseName TEXT, instructorName TEXT, semester TEXT, location TEXT, credits TEXT, isActive BOOLEAN)");
