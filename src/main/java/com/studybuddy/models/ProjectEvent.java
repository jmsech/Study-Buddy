...
public class ProjectEvent extends AssessmentEvent {
    ...
    public ProjectEvent(int id, String title, LocalDateTime startTime, LocalDateTime endTime, String description, List<User> hosts, double weight,
                        ParticularCourse course, List<Event> studyEvents, List<User> group, List<Event> meetings) {
        super(id, title, startTime, endTime, description, hosts, weight, course, studyEvents);
        this.group = group;
