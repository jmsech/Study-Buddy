...
public class ParticularCourse implements Cloneable{
    ...
    public ParticularCourse(String courseId, String courseName, String courseDescription,
                            String courseNumber, String semester, String section,
                            boolean active, List<User> students, List<User> tas,
                            String instructor, List<Event> classEvents) {
