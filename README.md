...
NOTE: The Google calendar integration button works fully in the local verision of the app but is currently dissabled in the heroku deployment, this is an issue to be resolved in the next iteration. To use StudyBuddy with Google Calendar integration download the project as described below.
